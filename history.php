...
<body>
    <div class="container-lg my-lg-5 py-5 my-2">
        <div class="d-flex row justify-content-between align-items-center">
            ...
            <div class="offcanvas offcanvas-start pt-3" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel" data-bs-scroll="true">
        ...
        <!-- <div class="collapse mb-3" id="collapseSearch">
            <input onkeyup="showHint(this.value)" type="text" class="form-control" id="searchInput" placeholder="Search...">
        </div> -->
        <?php
        echo 
            $sukses = "";
        ...
        ?>
        <div class="table-responsive" id="hintText"></div>
        <div class="table-responsive" id="patientData">
            <table class="table table-striped">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="text-center fs-md fs-sm" scope="col">Employee ID</th>
...
//          }
//       };
//       xmlhttp.open('GET', 'include/search.inc.php?q=' + inputText, true);
//       xmlhttp.send();
//    }
// }
